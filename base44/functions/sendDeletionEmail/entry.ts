...
Deno.serve(async (req) => {
  ...
  await base44.integrations.Core.SendEmail({
    to: userEmail,
    subject: hadRequest ? '✅ Votre compte Brenne Aerial a été supprimé' : '🔴 Votre compte Brenne Aerial a été supprimé',
    body: emailTemplate({ title: 'Suppression de compte', preheader: 'Votre compte Brenne Aerial a été supprimé.', bodyHtml }),
  });
