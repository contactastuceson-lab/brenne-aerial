...
const translations = {
  fr: {
    ...
    admin: { title: 'Administration', quotes: 'Devis', appointments: 'Rendez-vous', users: 'Utilisateurs', accounts: 'Comptes', certifications: 'Certifications', messaging: 'Messagerie', stats: 'Statistiques', settings: 'Paramètres', emailing: 'Emailing', pricing: 'Tarification' },
  ...
  en: {
    ...
    admin: { title: 'Administration', quotes: 'Quotes', appointments: 'Appointments', users: 'Users', accounts: 'Accounts', certifications: 'Certifications', messaging: 'Messaging', stats: 'Statistics', settings: 'Settings', emailing: 'Emailing', pricing: 'Pricing' },
