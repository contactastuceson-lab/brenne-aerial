...
const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'partners', icon: Handshake, path: '/admin/partners', label: 'Partenaires' },
    ]
  },
  {
    label: 'Communication',
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'automations', icon: Bot, path: '/admin/automations', label: 'Automatisations' },
