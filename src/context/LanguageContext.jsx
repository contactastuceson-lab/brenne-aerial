...
const translations = {
  fr: {
    ...
    admin: { title: 'Administration', quotes: 'Devis', appointments: 'Rendez-vous', users: 'Utilisateurs', messaging: 'Messagerie', stats: 'Statistiques', settings: 'Paramètres' },
  ...
  en: {
    ...
    admin: { title: 'Administration', quotes: 'Quotes', appointments: 'Appointments', users: 'Users', messaging: 'Messaging', stats: 'Statistics', settings: 'Settings' },
