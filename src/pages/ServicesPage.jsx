...
const SERVICES = [
  ...
  {
    key: 'photogrammetrie_3d', icon: Building2, color: 'text-primary',
    title: 'Photogramm. 3D',
    tagline: 'Modélisation numérique précise',
    desc: "Créez des modèles 3D détaillés par photogramm métrie aérienne. Parfait pour la documentation, la conservation du patrimoine et les projets d'architecture.",
    features: ['Nuages de points HD', 'Maillage 3D haute précision', 'Ortho-mosaïques', 'Rapport de mesure', 'Export multi-formats'],
    image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&auto=format&fit=crop&q=70',
  },
  {
    key: 'cartographie_releves', icon: HardHat, color: 'text-chart-5',
    title: 'Cartographie & Relevés',
    tagline: 'Cartographie aérienne topographique',
    desc: "Cartes précises géoréférencées et relevés topographiques pour vos projets d'aménagement, d'études d'impact et de planification urbaine.",
    features: ['Cartes géoréférencées', 'Relevés précis', 'Plans topographiques', 'Intégration SIG', 'Certification RTK'],
    image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&auto=format&fit=crop&q=70',
  },
  {
    key: 'thermographie', icon: Camera, color: 'text-accent',
    title: 'Thermographie infrarouge',
    tagline: 'Inspection thermique aérienne',
    desc: "Détectez les déperditions énergétiques, diagnostiquez les problèmes mécaniques et inspectez les installations électriques sans contact.",
    features: ['Caméra thermique 640x512', 'Analyse radiométrique', 'Rapports d\'anomalie', 'Haute précision', 'Industries variées'],
    image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&auto=format&fit=crop&q=70',
  },
  {
    key: 'surveillance', icon: Video, color: 'text-destructive',
    title: 'Surveillance & Gardiennage aérien',
    tagline: 'Couverture aérienne continue',
    desc: "Surveillance de sites sensibles, gardiennage aérien et monitoring de zones étendues. Dissuasion efficace et documentation en temps réel.",
    features: ['Couverture 24/7', 'Alertes temps réel', 'Archivage sécurisé', 'Intégration CMS', 'Intervention rapide'],
    image: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&auto=format&fit=crop&q=70',
  },
  {
    key: 'contenu_social', icon: Video, color: 'text-primary',
    title: 'Contenu réseaux sociaux',
    tagline: 'Vidéos créatives pour vos plateformes',
    desc: "Reels, shorts, TikToks avec perspective aérienne. Contenu viral et engageant pour amplifier votre présence sur les réseaux.",
    features: ['Format verticaux/horizontaux', 'Effets & transitions', 'Musique & colorisation', 'Optimisation SEO', 'Multi-plateforme'],
    image: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&auto=format&fit=crop&q=70',
  },
  {
    key: 'reportage', icon: Video, color: 'text-accent',
    title: 'Reportage & Documentaire',
    tagline: 'Contenu documentaire professionnel',
    desc: "Reportages aériens, documentaires et contenus éditoriaux avec production cinématographique complète. Narration, montage et post-production avancés.",
    features: ['Production complète', 'Narration professionnelle', 'Montage cinéma', 'Étalonnage couleur', 'Master DCI 4K'],
    image: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&auto=format&fit=crop&q=70',
  },
  {
    key: 'mariage_aero', icon: Camera, color: 'text-green-400',
    title: 'Mariage photo aérienne',
    tagline: 'Photos aériennes d\'amour',
    desc: "Captez votre plus beau jour depuis le ciel. Photos aériennes romantiques et vidéo cinématographique pour vos plus beaux souvenirs.",
    features: ['Séance d\'une journée', 'Photos retouchées', 'Album numérique', 'Diaporama musical', 'Tirage premium'],
    image: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&auto=format&fit=crop&q=70',
  },
  {
    key: 'immobilier_virtuelle', icon: Building2, color: 'text-primary',
    title: 'Visite immobilière virtuelle',
    tagline: 'Tour 360° de vos propriétés',
    desc: "Visite virtuelle immersive 360° de vos biens immobiliers. Décuplé la visibilité et facilitez les visites à distance.",
    features: ['Visite 360° complète', 'Navigation fluide', 'Géolocalisation', 'Intégration portails', 'Multidevices'],
    image: 'https://images.unsplash.com/photo-1509316785289-025f5b846b35?w=800&auto=format&fit=crop&q=70',
  },
  {
    key: 'agriculture', icon: HardHat, color: 'text-chart-5',
    title: 'Agriculture & Monitoring de cultures',
    tagline: 'Monitoring aérien agricole intelligent',
    desc: "Surveillance de cultures, détection de maladies, cartographie d'irrigation. Optimisez vos rendements avec l'analyse aérienne.",
    features: ['Imagerie multispectrale', 'Indices NDVI', 'Cartographie d\'humidité', 'Alertes anomalies', 'Rapports agronomes'],
    image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&auto=format&fit=crop&q=70',
  },
];
