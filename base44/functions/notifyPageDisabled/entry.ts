...
<body>
  <div class="wrapper">
    ...
    <div class="card" style="background:#070d1a;">
      <p style="margin:0;"><strong style="color:#e0eaf5;">Une question ?</strong> Contactez-nous à <a href="mailto:contact@brenne-aerial.fr" style="color:#38aadc;">contact@brenne-aerial.fr</a>. Notre équipe vous répondra dans les 24h.</p>
    </div>
