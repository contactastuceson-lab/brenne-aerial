...
const COLORS = { verified: 'rgb(29, 155, 240)', pro: 'rgb(34, 197, 94)', official: 'rgb(168, 85, 247)', certified: 'rgb(250, 204, 21)', government: 'rgb(134, 142, 150)', urgency: 'rgb(239, 68, 68)', moderator: 'rgb(220, 38, 38)', beta: 'rgb(244, 63, 94)', donor: 'rgb(252, 165, 165)' };
...
export default function VerificationMark({ type = 'verified', className = '', size = '1.1em', marginLeft = '2px' }) {
  ...
  const isRosette = ['verified', 'pro', 'official', 'urgency', 'moderator', 'beta', 'donor'].includes(type);
