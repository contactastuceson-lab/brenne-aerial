...
export default function Login() {
  ...
  return <div className="flex min-h-screen bg-background"><AuthBrandPanel /><main className="flex flex-1 items-center justify-center px-6 py-12"><div className="w-full max-w-md">
    ...
    <button onClick={() => base44.auth.loginWithProvider('google', '/')} className="mt-8 flex h-11 w-full items-center justify-center gap-2 rounded-xl border border-border bg-card font-inter text-sm font-semibold hover:bg-secondary"><span className="text-lg">G</span> Continuer avec Google</button>
