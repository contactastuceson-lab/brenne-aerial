      ...
      <table width="580" cellpadding="0" cellspacing="0" style="max-width:580px;width:100%;">
        ...
        <tr><td style="background:linear-gradient(145deg,#0c1a30,#0f2040);border:1px solid rgba(56,170,220,0.2);border-radius:16px;overflow:hidden;">
          ...
          <tr><td style="padding:36px 40px;">
            ...
            <table cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
              <tr>
                <td style="vertical-align:middle;">
                  <div style="width:52px;height:52px;border-radius:50%;background:linear-gradient(135deg,#1a3a5c,#0f2a44);border:2px solid rgba(56,170,220,0.4);display:flex;align-items:center;justify-content:center;font-size:22px;font-weight:700;color:#38aadc;text-align:center;line-height:52px;">
            ...
            <!-- Title -->
            <h1 style="margin:0 0 8px;font-size:24px;font-weight:800;color:#e8edf5;line-height:1.2;">
            ...
            <table cellpadding="0" cellspacing="0">
              <tr><td style="border-radius:10px;background:linear-gradient(135deg,#38aadc,#1b8ab8);">
                <a href="${APP_URL}/messages" style="display:inline-block;padding:14px 32px;font-size:15px;font-weight:700;color:#fff;text-decoration:none;letter-spacing:0.3px;">
                  💬 Répondre au message →
                </a>
              </td></tr>
            </table>
        ...
        <tr><td style="padding-top:28px;text-align:center;">
          <p style="font-size:12px;color:#2a4060;margin:0;">
            Brenne Aerial · <a href="${APP_URL}" style="color:#38aadc;text-decoration:none;">brenneaerial.fr</a>
          </p>
          <p style="font-size:11px;color:#1e3050;margin:6px 0 0;">
            Vous recevez cet email car quelqu'un vous a envoyé un message sur notre plateforme.
          </p>
        </td></tr>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#030810;padding:40px 16px;">
    <tr><td align="center">
      <table width="580" cellpadding="0" cellspacing="0" style="max-width:580px;width:100%;">
        ...
        <!-- Card officiel -->
        <tr><td style="background:linear-gradient(160deg,#080f20,#0a1830,#06111e);border:1px solid rgba(56,170,220,0.35);border-radius:16px;overflow:hidden;box-shadow:0 0 40px rgba(56,170,220,0.08);">
          ...
          <tr><td style="padding:40px 44px;">
            ...
            <table cellpadding="0" cellspacing="0" style="margin-bottom:30px;width:100%;">
              <tr>
                <td style="vertical-align:middle;">
                  <div style="width:58px;height:58px;border-radius:14px;background:linear-gradient(135deg,#0e2848,#0a1e38);border:1.5px solid rgba(56,170,220,0.5);text-align:center;line-height:58px;font-size:26px;box-shadow:0 0 20px rgba(56,170,220,0.2);">
                    🛡️
                  </div>
                </td>
            ...
            <p style="margin:0 0 26px;font-size:14px;color:#5a7a9a;line-height:1.6;">
              ${recipientName ? `Bonjour <strong style="color:#a0c0d8;">${recipientName}</strong>,` : 'Bonjour,'} vous avez reçu un message officiel de l'équipe Brenne Aerial. Ce message vous a été adressé directement par notre direction.
            </p>
            ...
            <!-- Read-only notice -->
            <p style="font-size:12px;color:#2e4a6a;margin:12px 0 32px;display:flex;align-items:center;gap:6px;">
              🔒 <em>Ce message est en lecture seule — il n'est pas possible d'y répondre directement.</em>
            </p>

            <!-- CTA -->
            <table cellpadding="0" cellspacing="0">
              <tr><td style="border-radius:10px;background:linear-gradient(135deg,#0e3a6a,#1a5a9a);border:1px solid rgba(56,170,220,0.3);">
                <a href="${APP_URL}/messages" style="display:inline-block;padding:14px 32px;font-size:15px;font-weight:700;color:#e8edf5;text-decoration:none;letter-spacing:0.3px;">
                  📬 Voir le message →
                </a>
              </td></tr>
            </table>
        ...
        <tr><td style="padding-top:32px;text-align:center;">
          ...
          <p style="font-size:12px;color:#1e3050;margin:0 0 6px;">
            <strong style="color:#2a4a7a;">Brenne Aerial</strong> · Communication officielle
          </p>
          <p style="font-size:11px;color:#182840;margin:0;">
            <a href="${APP_URL}" style="color:#2a5080;text-decoration:none;">brenneaerial.fr</a> · Ce message a été envoyé par notre équipe de direction.
          </p>
        </td></tr>
...
Deno.serve(async (req) => {
  try {
    ...
    const subject = isOfficial
      ? `📢 Message officiel de Brenne Aerial`
      : `💬 ${senderName} vous a envoyé un message`;

    const body = isOfficial
      ? buildOfficialMessageEmail({ preview, recipientName })
      : buildNormalMessageEmail({ senderName, senderEmail, preview, recipientName });
