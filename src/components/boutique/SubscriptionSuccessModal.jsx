...
const SUB_INFO = {
  ...
  enterprise: {
    ...
    iconBorder: 'border-zinc-400/40',
    iconColor: 'text-zinc-300',
    badgeBg: 'bg-zinc-500/20',
    badgeBorder: 'border-zinc-400/40',
    textGradient: 'bg-gradient-to-r from-zinc-200 via-slate-300 to-zinc-200 bg-clip-text text-transparent',
    ringColor: '#a1a1aa',
    confetti: ['#a1a1aa', '#d4d4d8', '#e4e4e7', '#fbbf24', '#38bdf8'],
    tagline: "Le badge Gouvernement — pour les institutions et entités officielles.",
    perks: [
      'Badge Gouvernement \u2713',
      'Tous les avantages Business inclus',
