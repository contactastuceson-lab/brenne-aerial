...
import { UserPlus, UserCheck, Search, MessageCircle, Users } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-10">
          ...
          <p className="font-inter text-sm text-muted-foreground ml-11">
            Explorez les profils et connectez-vous avec la communauté
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <AnimatePresence>
            {filtered.map((profile, i) => {
              ...
              const convId = getConversationId(user.email, profile.email);
              ...
              return (
                ...
                >
                  ...
                  <div className="px-5 -mt-8 pb-5">
                    <div className="w-16 h-16 rounded-2xl border-2 border-border bg-secondary flex items-center justify-center mb-3 overflow-hidden sky-glow">
                      {profile.avatar_url ? (
                    ...
                    <p className="font-mono text-[10px] text-muted-foreground truncate mb-1">{profile.email}</p>

                    {profile.role && (
                      <span className="inline-block font-mono text-[9px] text-primary/80 bg-primary/10 border border-primary/20 px-2 py-0.5 rounded-full mb-4">
                        {profile.role}
                      </span>
                    )}
